...
double GeoMath::distance(double lat1Rad, double lon1Rad, double lat2Rad, double lon2Rad, double radius)
{
...
//double GeoMath::distance(const std::vector< Vector3 > &points, double radius)
//{
//    double length = 0;
//
//    if (points.size() > 1)
...
//double
//GeoMath::distance(const Vector3& p1, const Vector3& p2, const SpatialReference* srs )
//{
...
double GeoMath::bearing(double lat1Rad, double lon1Rad,
...
//void GeoMath::greatCircleMinMaxLatitude(double lat1Rad, double lon1Rad,
//                                   double lat2Rad, double lon2Rad,
...
//        out_maxLatRad = std::min( out_maxLatRad, osg::PI_2 - asin(sin(B)*sin(a)) );
...
//}
//
//void GeoMath::midpoint(double lat1Rad, double lon1Rad,
//                  double lat2Rad, double lon2Rad,
...
void GeoMath::destination(double lat1Rad, double lon1Rad,
...
//double GeoMath::rhumbDistance(double lat1Rad, double lon1Rad,
//                       double lat2Rad, double lon2Rad,
//                       double radius)
//{
//    double dLat = (lat2Rad - lat1Rad);
...
//double GeoMath::rhumbDistance(const std::vector< osg::Vec3d > &points, double radius)
//{
//    double length = 0;
//    if (points.size() > 1)
//    {
...
//double GeoMath::rhumbBearing(double lat1Rad, double lon1Rad,
//                      double lat2Rad, double lon2Rad)
//{
//    double dLon = lon2Rad - lon1Rad;
//
...
//bool GeoMath::isPointVisible(const Vector3& eye,
